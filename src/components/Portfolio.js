          ...
          <div className="four columns header-col">
            <div class="card" id="Cards">
              ...
              <div class="card-body">
                ...
                <hr></hr>
                <p class="card-text">Search for events of all kinds using Google Maps and Ticket Master APIs! Try out the authentication using Google's FireBase to log in and save events.</p>
              </div>
            </div>
          </div>
          ...
          <div className="four columns header-col">
            <div class="card" id="Cards">
              ...
              <div class="card-body">
                ...
                <hr></hr>
                <p class="card-text">An eCommerce platform in which users can post, update, save and delete items using MySQL. (STILL IN DEVELOPMENT)</p>
              </div>
            </div>
          </div>
